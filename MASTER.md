...
Бот: Предпросмотр рассылки:
     ...
     Примеры получателей: 123456789, 987654321, 111222333, 444555666, 777888999, 101112131
...
- **Изменения применяются мгновенно** — при каждом открытии календаря система обновляет данные из `WorkHours`, поэтому изменения в расписании видны клиентам сразу без перезагрузки бота
- В календаре записи отображаются **только рабочие дни** — дни без записей в `WorkHours` автоматически скрываются
