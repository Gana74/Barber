...
- Контакты хранятся в Google Sheets в листе "Настройки" с ключами `телефон_барбера` и `адрес_барбера`
...
- `телефон_барбера` — телефон салона, отправляемый клиентам в напоминаниях (можно редактировать через админ-меню)
- `адрес_барбера` — адрес салона, отправляемый клиентам в напоминаниях (можно редактировать через админ-меню)
...
| телефон_барбера         | +7 999 123-45-67                            |
| адрес_барбера           | ул. Ленина, д. 10                            |
