...
Позволяет настроить ссылку на чаевые, которая будет отправляться клиентам при автоматическом завершении услуги.
...
3. Бот покажет текущую ссылку (или сообщит, что ссылка не установлена)
4. Отправьте новую ссылку
5. Бот сохранит ссылку и подтвердит изменение
...
Бот: Текущая ссылка на чаевые:

     https://t.me/your_tips_bot

     Отправьте новую ссылку (должна начинаться с http://, https:// или t.me/).
     Для отмены напишите /admin_cancel

Вы: https://t.me/new_tips_bot

Бот: Ссылка на чаевые успешно обновлена!
...
- Ссылка будет автоматически добавлена в уведомление клиентам при завершении услуги
- Если ссылка не установлена, уведомление будет отправлено без ссылки на чаевые
...
- `ссылка_на_чаевые` — ссылка на чаевые, отправляемая клиентам при завершении услуги (можно редактировать через админ-меню)
...
**Важно:** Не изменяйте настройки без необходимости. Неправильная таймзона может привести к ошибкам в расписании. Рекомендуется редактировать настройки через админ-меню бота.
...
После автоматического завершения записи клиент получает уведомление с благодарностью и ссылкой на чаевые (если ссылка настроена в админ-меню).

**Пример сообщения клиенту:**

```

Мужская стрижка завершена, благодарю что выбираете меня! В благодарность мастеру можете дать чаевые https://t.me/your_tips_bot
...
- Если ссылка на чаевые не настроена, уведомление отправляется без ссылки
- Ссылку на чаевые можно настроить через админ-меню (см. раздел "Редактирование ссылки на чаевые")
