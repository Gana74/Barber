...
1. Нажмите кнопку **"Редактировать ссылку на чаевые"**
2. Бот покажет текущую ссылку (или сообщит, что ссылка не установлена)
3. Отправьте новую ссылку
4. Бот сохранит ссылку и подтвердит изменение
