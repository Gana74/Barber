...
- `Настройки` — ключ/значение (колонки: `Ключ`, `Значение`). Хранит системные настройки: `таймзона`, `напоминание_21день_текст`, `ссылка_на_чаевые`, `телефон_барбера`, `адрес_барбера`
